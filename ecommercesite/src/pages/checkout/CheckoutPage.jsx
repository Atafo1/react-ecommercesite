...
export function CheckoutPage({ cart,loadCart }) {
  ...
  useEffect(() => {
    ...
    let response=   await axios .get("https://react-ecommercesitebackend.onrender.com/api/delivery-options?expand=estimatedDeliveryTime");
     
        setDeliveryOptions(response.data);
    

    response= await axios.get("https://react-ecommercesitebackend.onrender.com/api/payment-summary");
    ...
    let response= await axios.get("https://react-ecommercesitebackend.onrender.com/api/payment-summary");
      setPaymentSummary(response.data);
